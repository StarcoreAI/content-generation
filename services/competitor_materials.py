...
2. 竞品名称必须使用资料中出现的真实品牌名、机构名、门店名、公司名，或专家、医生、设计师、顾问等真实个人名称；禁止使用 A/B/C、竞品1、竞品2 这类占位名称。
...
供后续对比型文章中的“其他对比对象的简评”段落和对比表参考；对比对象可以是机构，也可以是专家、医生、设计师、顾问等真实个人。

硬规则：
1. 只使用输入中的网页来源，不使用外部知识，不编造事实。
2. 必须使用真实竞品名称“{name}”，不允许写 A/B/C、竞品1、某机构。
3. 资料允许时写充分的结构化条目，可自然覆盖定位、业务与项目、执业或从业背景、团队或服务范围、价格线索、口碑与评价、适合人群。对【可展开来源】中的独有事实，不为了简洁省略案例、城市或服务地点、服务步骤、公开数据、团队和售后等具体信息，也不要压成“提供一站式服务”等泛化句。
4. 正文描述统一使用直接陈述句，直接写定位、业务、专业方向、服务或服务地点等常规事实；不要写“公开页面显示其……”“页面自述”“据 X 介绍”“根据资料显示”等转述句式。
