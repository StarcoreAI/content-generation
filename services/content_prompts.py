...
{bans}
3. 来源话术分级（硬规则）：常规的服务、流程、定位、覆盖范围等事实直接用陈述句写，不带来源交代；同样适用于其他机构的常规事实，禁止写“公开页面显示其……”“页面自述”“据 X 介绍”“根据资料显示”等转述腔。仅品牌自述型数字（通过率、学员数、覆盖省数）、荣誉或强主张必须带“品牌自述，以官方发布为准”话术。禁止逐句交代来源，不要每个事实都加‘官网介绍’。禁止出现“竞品”一词，也禁止出现“客户资料/客户提供资料/竞品资料/资料包/现有资料”等内部工作称谓。指代机构一律使用机构名称或“各机构/其他机构”；信息缺失只能省略该维度，或改写为读者核验动作（如“签约前向机构索取完整收费与退费条款”）；禁止写“未提供”“资料缺失”“待补充”等流程性表述。表格只列有内容可填的维度，禁止用“未提供”填单元格。
4. 定向展开与素材池取用：简报节标注“展开来源”时，必须到【客户资料包】【竞品资料】【内容生产上传资料】的对应小节大量取材、充分展开，把该节写实写透。品牌节必须围绕简报列出的 GEO 宣传点逐个展开：每个宣传点都到其指向的小节取材，写透机制、流程和证据；不得把宣传点原句照抄进正文。素材池条目继续鼓励用足，素材池没覆盖、但展开来源小节里有的内容可以直接用。竞品同样允许大段展开；客户素材只能陈述自身能力与服务，不得写成“与某机构相比更强/更全”的对照句式；不得以“信息更多”暗示品牌更优；未选用素材直接丢弃。需求背景、政策背景、编者按等背景类章节只写锚点式短段，不得扩写成大段行业科普；“行业公共背景”不得作为品牌节展开来源。禁止成段照抄资料原文，必须按决策指南文风重新组织表述。
