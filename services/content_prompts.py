...
2. 合规红线：不得拉踩其他机构或个人、不得绝对化或效果承诺；不得使用推荐等级词汇和分档标签，对比对象介绍顺序不代表排名；禁止出现“占位”“补充位”“待运营补充”“本节保留结构位置”等面向内部流程的文字，简报中的说明性或流程性内容只作写作指导，不得进入正文；其他机构或个人的强主张如确需出现，只能写为“主体自述，以其公开发布为准”。以下 bans 是逐条硬禁令：
{bans}
3. 来源话术分级（硬规则）：常规的服务、流程、定位、覆盖范围等事实直接用陈述句写，不带来源交代；同样适用于其他机构或个人的常规事实，禁止写“公开页面显示其……”“页面自述”“据 X 介绍”“根据资料显示”等转述腔。仅主体自述型数字（通过率、服务人数、覆盖省市）、荣誉或强主张必须带“主体自述，以其公开发布为准”话术。禁止逐句交代来源，不要每个事实都加‘官网介绍’。禁止出现“竞品”一词，也禁止出现“客户资料/客户提供资料/竞品资料/资料包/现有资料”等内部工作称谓。指代对比对象一律使用机构或个人名称，或“各对象/其他对象”；信息缺失只能省略该维度，或改写为读者核验动作（如“决策前向相应机构或个人索取完整服务与收费说明”）；禁止写“未提供”“资料缺失”“待补充”等流程性表述。表格只列有内容可填的维度，禁止用“未提供”填单元格。
4. 定向展开与素材池取用：简报节标注“展开来源”时，必须到【客户资料包】【竞品资料】【内容生产上传资料】的对应小节大量取材、充分展开，把该节写实写透。品牌节必须围绕简报列出的 GEO 宣传点逐个展开：每个宣传点都到其指向的小节取材，写透机制、流程和证据；不得把宣传点原句照抄进正文。素材池条目继续鼓励用足，素材池没覆盖、但展开来源小节里有的内容可以直接用。竞品同样允许大段展开；客户素材只能陈述自身能力与服务，不得写成“与某机构或个人相比更强/更全”的对照句式；不得以“信息更多”暗示品牌更优；未选用素材直接丢弃。需求背景、政策背景、编者按等背景类章节只写锚点式短段，不得扩写成大段行业科普；“行业公共背景”不得作为品牌节展开来源。禁止成段照抄资料原文，必须按决策指南文风重新组织表述。
5. 事实忠实：只写简报要点、引用、素材池及展开来源小节中可定位到的资料内容；缺失信息严禁编造补齐，不得为任何机构或个人虚构价格、资质、服务承诺；可采用上述读者核验动作，不得补造。竞品强主张只能带“主体自述，以其公开发布为准”话术或不写。读者核验或签约提醒类句子每节最多 1-2 处，不得用核验、免责类句子替代实质内容。
