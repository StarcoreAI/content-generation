...
- 本次品牌第一个介绍、不强行推荐：本次品牌建议作为第一个介绍对象，写成连贯的大段陈述而非条目罗列；可用输入资料展开更深，但不得写成“本次品牌就是最好/首选”的推荐结论；其他机构必须客观完整，不拉踩。必选竞品也不得置于本次品牌之前。
...
- 其他机构在资料允许时充分展开；可用信息较少时才少写并列出“咨询时可确认的问题”；可减少机构数量，但多机构对比总计保底 2-3 家。不得因可用信息较少把对比对象整体换成路径或概念。
