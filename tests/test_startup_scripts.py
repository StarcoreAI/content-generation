...
class StartupScriptTests(unittest.TestCase):
    ...
    def test_mac_operator_launchers_use_shell_and_python_worker(self):
        ...
        self.assertIn('ln -s "Versions/Current/$name"', setup)
    ...
    def test_mac_operator_package_script_builds_complete_arm64_zip(self):
        ...
        self.assertIn("--exclude output", script)
        self.assertIn("--exclude interviews", script)
        self.assertIn("chmod +x", script)
        self.assertIn("chrome_crashpad_handler", script)
